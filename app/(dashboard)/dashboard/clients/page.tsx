...
import { useClients, useDeleteClient, type Client } from '@/lib/queries/clients'
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    <Badge variant="outline" className={SERVICE_TYPE_COLORS[client.service_type]}>
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              {deletingClient?.full_name} will be removed from your client list.
